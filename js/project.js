$(function(){
	...
	function dimFadeInOut(){
		...
		$("body").append(dimHtml);
		$(".prev_page_dim").delay(400).animate({height:0}, 400, function(){
	...
	$(".burger_menu button").click(function(){
		lnbClicked=true;
		$(".west .nav").animate({left:20, opacity:1}, 300);
	...
	$(".nav > li > a, h1 > a").click(function(e){
		...
		$(".next_page_dim").delay(400).animate({height:"100vh"}, 400, function(){
	...
	$(".bottom_area a").hover(
		function(){
			...
			$(this).stop().animate({backgroundColor:"#9966ff;", color:"#fff"}, 300);
		},
		function(){
			if($(this).is(".nolink")) return;
